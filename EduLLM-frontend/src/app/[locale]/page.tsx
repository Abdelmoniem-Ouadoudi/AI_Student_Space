...
export default function LandingPage() {
  ...
  const quickActions = [
    ...
    <LazyComponents>
      ...
      <section className="py-20 lg:py-32">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <div className="space-y-8">
            {/* Logo */}            <AnimatedSection delay={0.2}>
              <div className="flex justify-center mb-6">
                <div className="w-32 h-32 flex items-center justify-center overflow-hidden rounded-2xl bg-slate-800/30 p-2 shadow-lg border border-slate-700/50">
                  <img 
      ...
      </AnimatedSection>      {/* End of content */}
    </div>
    </LazyComponents>
  );
}
